...
const backGroundStyle = {
  color:
    'linear-gradient(90deg,rgba(255,255,255,1) 0%,rgba(255,255,255,1) 30%,rgb(58, 102, 183) 30%,rgb(87, 179, 194) 100%) !important',
};
  ...
  return (
    <>
      <Router>
        <UITemplate {...theme}>
          <CssBaseline />
          <div style={{background: backGroundStyle.color}}> </div>
          <Header>
            <Navigation
              email="mailto:#"
